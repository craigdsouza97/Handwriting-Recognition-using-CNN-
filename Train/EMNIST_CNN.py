...
#from keras.layers.convolutional import Conv2D, Cropping2D, ZeroPadding2D, MaxPooling2D, AveragePooling2D
...
classes=47
#%%:
#train = pd.read_csv('C:/Users/CRAIG/Untitled Folder/Preprocessing/emnist-balanced-train.csv', header=None)
test = pd.read_csv('C:/Users/CRAIG/Untitled Folder/Preprocessing/emnist-balanced-test.csv',header=None)
...
#mc = ModelCheckpoint('C:/Users/CRAIG/Desktop/api/Models/hr3.h5', monitor='val_acc', mode='max', verbose=1, save_best_only=True)
#
...
#model.fit_generator(train_gen, steps_per_epoch=len(x_train)/20, epochs=35,validation_data=(x_test, y_test),callbacks=[es,mc],shuffle=True)
#saved_model = tf.keras.models.load_model('C:/Users/CRAIG/Desktop/api/Models/hr3.h5')
## evaluate the model
